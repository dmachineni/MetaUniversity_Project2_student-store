...
### GIFs
- Categories
![CategoriesStudentStore](https://user-images.githubusercontent.com/68713537/175751701-c91b3e81-2678-4365-a3e1-58def21a518c.gif)
- Product Details
![ProductDetailsStudentStore](https://user-images.githubusercontent.com/68713537/175751727-de94d6d0-3e9b-4cfa-a186-cf2566eaaa8f.gif)
- Checkout
![CheckoutStudentStore](https://user-images.githubusercontent.com/68713537/175751743-ffaf1b27-a5ad-4d72-8edd-960afd6010bd.gif)
- Home Page and Navbar Icon
...
#### Stretch Features for Week 2
- [x] User can click to expand the shopping cart in the left navigation.
- [x] User can click the '+' button on a product cart to increment that product in the shopping cart.
- [x] User can click the '-' button on a product cart to increment that product in the shopping cart.
- [x] Shopping cart displays a table of products, quantities, subtotal, tax, and total.

### Core Features for Week 3
- [x]User can click to expand the shopping cart in the left navigation.
- [x] User can click the '+' button on a product cart to increment that product in the shopping cart.
- [x]User can click the '-' button on a product cart to increment that product in the shopping cart. If the count is zero, the product should be removed from the cart.
- [x]Shopping cart displays a table of products, quantities, subtotal, tax, and total.
...
* Did the topics discussed in your labs prepare you to complete the assignment? Be specific, which features in your weekly assignment did you feel unprepared to complete?
  ...
  Yes the labs that I worked on helped me learn React and understand how the parameters are passed and the body of the page is rendered. 

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
  I would have added some more CSS to make the website look prettier. While working on the project, I focused on functionality more than how the website looks. 

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

  I would like to add more CSS code so that the website is more accessible and user friendly. I would also like to figure out how to create a modify my own icons. 
